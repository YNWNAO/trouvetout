...
export default function FastBuy229() {
  ...
  // ==================== STYLES POUR BOUTON MOT DE PASSE ====================
  const pwdButtonStyle = {
    ...
    cursor: "pointer",
    fontSize: 18,
    color: "#374151", // 🎯 GRIS FONCÉ = VISIBLE
    padding: "4px 8px",
    zIndex: 10, // 🎯 AU-DESSUS DE L'INPUT
    lineHeight: 1,
    transition: "all 0.2s"
  };
          ...
          <div className="modal">
            ...
            <div style={{ position: "relative", marginBottom: 12 }}>
              <input 
                ...
                value={inscForm.confirmer} 
                onChange={e => setInscForm({ ...inscForm, confirmer: e.target.value })} 
                style={{ ...inp, marginBottom: 0, paddingRight: 40 }} 
              />
              <button
                type="button"
